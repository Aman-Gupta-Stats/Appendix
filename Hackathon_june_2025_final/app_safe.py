    ...
    if st.session_state.compare_difference == True:
        ...
        with od:
            ...
            with cl[0]:
                ...
                owner_details_edit = st.data_editor(owner_details_styled, row_height = 56, height = 598,
                                                    column_config = {
                                                        "Comments": st.column_config.TextColumn("Comments"),
                                                        "Ask Client?": st.column_config.CheckboxColumn("Ask Client?", default = False),
                                                        "Complete": st.column_config.CheckboxColumn("Complete?", default = False)
                ...
                with cl[1]:
                    ...
                    with st.popover("Upload Evidence"):
                        od_evidence_4 = st.file_uploader("Upload Evidence", type="JPEG",accept_multiple_files = True,key = "od_evidence_4")

                    with st.popover("Upload Evidence"):
                        od_evidence_5 = st.file_uploader("Upload Evidence", type="JPEG",accept_multiple_files = True,key = "od_evidence_5")

                    with st.popover("Upload Evidence"):
                        od_evidence_6 = st.file_uploader("Upload Evidence", type="JPEG",accept_multiple_files = True,key = "od_evidence_6")

                    with st.popover("Upload Evidence"):
                        od_evidence_7 = st.file_uploader("Upload Evidence", type="JPEG",accept_multiple_files = True,key = "od_evidence_7")

                    with st.popover("Upload Evidence"):
                        od_evidence_8 = st.file_uploader("Upload Evidence", type="JPEG",accept_multiple_files = True,key = "od_evidence_8")

                    with st.popover("Upload Evidence"):
                        od_evidence_9 = st.file_uploader("Upload Evidence", type="JPEG",accept_multiple_files = True,key = "od_evidence_9")

                    with st.popover("Upload Evidence"):
                        od_evidence_10 = st.file_uploader("Upload Evidence", type="JPEG",accept_multiple_files = True,key = "od_evidence_10")
        ...
        with tr:
            final_list = ["CAAR"] + od_list + bd_list
    ...
    with caar:
        ...
        if st.session_state.fetch_transaction_data == True:
            ...
            if st.session_state.visualize_data == True:
                ...
                df_transaction = pd.read_excel("Data/transactions_xyz_company.xlsx")
...
def color_by_criticality(row):
    ...
    elif row["Issue Criticality"] == "Recommendation":
        return ["background-color: orange"] * len(row)
    elif row["Issue Criticality"] == "Minor changes":
